...
declare -A LISTS
LISTS=(
    ["list1_intergenic_cat.bed"]="Intergenowe"
    ["list2_intronic_cat.bed"]="Intronowe"
    ["list3_cds_one_exon_cat.bed"]="CDS 1 egzon"
    ["list4_exonic_multigene_cat.bed"]="Eksonowe multi-gen"
)
